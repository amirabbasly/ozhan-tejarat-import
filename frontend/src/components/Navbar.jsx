...
const Navbar = () => {
  ...
  const [language, setLanguage] = useState("Iran");
  const navigate = useNavigate();
  ...
  const getRole = () => profile?.role || user?.role || "user";
  ...
  return (
    <div className="font-vazir">
      ...
      {/* Sidebar Menu */}
      <div
        className={`fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm z-50 flex justify-end transition-transform duration-300 ${
          showMenu ? "translate-x-0" : "translate-x-full"
        }`}
      >
        <div className="bg-white w-full sm:w-80 h-full shadow-2xl p-6 flex flex-col gap-4 transform transition-transform duration-300 ease-in-out overflow-y-auto scrollbar-hidden">
          <button
            className="self-end text-gray-600 text-2xl hover:text-gray-800 transition-colors"
            onClick={closeMenu}
          >
            <FaTimes />
          </button>
          {/* Logo inside Dashboard (Right-to-Left) */}
          <div className="flex flex-row-reverse items-center gap-2 mb-4 text-right justify-center border-b border-gray-200 pb-4">
            ...
            >
              <path
                d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20ZM13 12H17V14H11V8H13V12Z"
                fill="currentColor"
              />
            </svg>
          </div>
          <ul className="flex flex-col gap-2 text-right">
            <li className="border-b border-gray-100 pb-2">
              <Link
                to="/"
                onClick={closeMenu}
                className="flex flex-row-reverse items-center gap-3 text-gray-700 px-4 py-3 rounded-lg w-full hover:bg-purple-50 hover:text-purple-700 transition-colors duration-200 bg-gray-50"
              >
            ...
            <li className="border-b border-gray-100 pb-2">
              ...
              {mobileSubmenu.asnad && (
                <ul className="flex flex-col gap-2 pr-4 mt-2 text-right">
                  {[
                    {
                      title: "ثبت سفارش ها",
                      key: "receive-order",
                      ...
                      submenu: [
                        { to: "/add-order", label: "ایجاد ثبت سفارش" },
                        { to: "/reged-orders", label: "لیست ثبت سفارش ها" },
                        getRole() === "admin" && {
                          to: "/import-prf",
                          label: "دریافت از سامانه",
                        },
                      ],
                    },
                    {
                      ...
                      submenu: [
                        { to: "/expense-list", label: "لیست هزینه ها" },
                        { to: "/cottages", label: "لیست اظهارنامه ها" },
                        {
                          to: "/cottage-goods-list",
                          label: "لیست کلی کالا ها",
                        },
                        getRole() === "admin" && {
                          to: "/decl",
                          label: "دریافت از سامانه",
                    ...
                    {
                      title: "اظهارنامه های صادراتی",
                      key: "exportDeclarations",
                      icon: <FaFileAlt className="text-gray-500" />,
                      submenu: [
                        { to: "/add-export", label: "ایجاد اظهارنمه" },
                        { to: "/export-cottages", label: "لیست اظهارنامه ها" },
                        getRole() === "admin" && {
                          to: "/export-decl",
                          label: "دریافت از سامانه",
                        },
                    ...
                    },
                    {
                      ...
                      icon: <FaFile className="text-gray-500" />,
                      submenu: [
                        { to: "/add-check", label: "ایجاد چک جدید" },
                        { to: "/checks", label: "لیست چک ها" },
                        { to: "/check-from-excel", label: "ورود چک" },
                      ],
                    },
                    {
                      title: "وکالت نامه ها",
                      ...
                      icon: <FaFileAlt className="text-gray-500" />,
                      submenu: [
                        { to: "/add-representation", label: "ایجاد وکالتنامه" },
                        { to: "/representations", label: "لیست وکالتنامه ها" },
                        { to: "/rep-from-excel", label: "ورود وکالتنامه" },
                      ],
                    },
                    {
                      title: "صدور اسناد",
                      ...
                      submenu: [
                        {
                          to: "/invoices/new",
                          label: "ایجاد اینوویس/پکینگ/گواهی مبدا",
                        },
                        {
                          to: "/invoices/list",
                          label: "لیست اینوویس/پکینگ/گواهی مبدا",
                        },
                        {
                          to: "/proforma-invoices/new",
                          label: "ایجاد پروفورما",
                        },
                        {
                          to: "/proforma-invoices/list",
                          label: "لیست پروفورما",
                    ...
                    },
                    {
                      ...
                      submenu: [
                        { to: "/sellers/new", label: "ایجاد فروشنده" },
                        { to: "/sellers/list", label: "لیست فروشنده ها" },
                        { to: "/buyers/new", label: "ایجاد خریدار" },
                        { to: "/buyers/list", label: "لیست خریدار ها" },
                        { to: "/customers/new", label: "ایجاد شخص جدید" },
                        { to: "/customers/list", label: "لیست اشخاص" },
                      ],
                    },
                  ].map((item, index) => (
                    <li key={index} className="border-b border-gray-100 pb-2">
                      ...
                      {mobileSubmenu[item.key] && (
                        <ul className="flex flex-col gap-1 pr-4 mt-1 text-right">
                          {item.submenu
                            .filter(Boolean)
                            .map((subItem, subIndex) => (
                              ...
                              >
                                <Link
                                  to={subItem.to}
                                  onClick={closeMenu}
                                  className="flex items-center gap-2 text-gray-700 px-4 py-2 rounded-lg w-full hover:bg-purple-50 hover:text-purple-700 transition-colors duration-200 bg-gray-50"
                                >
            ...
            <li className="border-b border-gray-100 pb-2">
              <button
                onClick={() => toggleMobileSubmenu("karbar")}
                className="flex flex-row-reverse items-center gap-3 text-gray-700 px-4 py-3 rounded-lg w-full hover:bg-purple-50 hover:text-purple-700 transition-colors duration-200 bg-gray-50"
              >
                <FaUser className="text-gray-500" />
                <span>
                  {profile?.username ||
                    (isAuthenticated && user ? user.username : "کاربر")}
                </span>
                <FaChevronDown
                  className={`transition-transform duration-200 ${
                    mobileSubmenu.karbar ? "rotate-180" : ""
                  }`}
                />
              </button>
              {mobileSubmenu.karbar && (
                <ul className="flex flex-col gap-1 pr-4 mt-1 text-right">
                  <li className="flex flex-row-reverse items-center">
                    <Link
                      to="/user/profile"
            ...
            <li className="border-b border-gray-100 pb-2">
              <button
                onClick={() => toggleMobileSubmenu("notifications")}
                className="flex flex-row-reverse items-center gap-3 text-gray-700 px-4 py-3 rounded-lg w-full hover:bg-purple-50 hover:text-purple-700 transition-colors duration-200 bg-gray-50"
              >
                ...
                <FaChevronDown
                  className={`transition-transform duration-200 ${
                    mobileSubmenu.notifications ? "rotate-180" : ""
                  }`}
                />
              </button>
          ...
          {/* User Info Section (Right-to-Left) */}
          <div className="mt-auto flex flex-row-reverse items-center gap-3 text-gray-700 text-right border-t border-gray-200 pt-4">
            <button
              className="mt-4 w-full bg-blue-500 text-white px-4 py-3 rounded-lg text-right flex flex-row-reverse items-center gap-2 justify-end hover:bg-blue-600 transition-colors duration-200"
              onClick={() =>
                (window.location.href = `tel:${
                  profile?.phone_number || "09123022064"
                }`)
              }
            >
              <FaPhone className="text-white" />
              <span>
                تماس با پشتیبانی ({profile?.phone_number || "09123022064"})
              </span>
            </button>
          </div>
        </div>
